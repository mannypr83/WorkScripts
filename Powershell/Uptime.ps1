$a = (Get-Content C:\Users\e836198\Documents\Scripts\powershell\vm_list.csv)
$x = Get-Content C:\Users\e836198\Documents\Scripts\powershell\vm_list.csv | Measure-Object -Line
